...
class UsuarioController {
    ...
    public function save(array $aDados): void {
        ...
        if ($sNivelAcesso !== 'administrador') {
            ...
            header('Location: http://localhost/programa_de_trainee/modulo_3/jquery/avaliacao/Usuario/listar');
        }
    ...
    public function cadastrarUsuario(array $aDados): void {
        ...
        if (!$bValidacao) {
            header('Location: http://localhost/programa_de_trainee/modulo_3/jquery/avaliacao/Usuario/save');
            return;
        } 
    ...
    public function editarModal(array $aDados): void {
        ...
        include __DIR__ . '/../view/modal/editar_usuario.php';
    }
    ...
    public function atualizarUsuario(array $aDados): void {
        ...
        if (!$bValidacao) {
            header("Location: http://localhost/programa_de_trainee/modulo_3/jquery/avaliacao/Usuario/editar/{$iIdUsuario}");
            return;
        }
