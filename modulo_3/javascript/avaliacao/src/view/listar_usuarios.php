...
<body>
    <div class="container">
        ...
        <a href="http://localhost/programa_de_trainee/modulo_3/javascript/avaliacao/Usuario/save">
            ...
            <tbody>
                <?php foreach ($aUsuarios as $aUsuario) { ?>
                    <tr>
                        ...
                        <th>
                           <a href="http://localhost/programa_de_trainee/modulo_3/javascript/avaliacao/Usuario/editar/<?php echo $aUsuario['id']?>">
                            <button class="botao-verde" >Editar</button>
                           </a> 
                        </th>
                        <th>
                           <a href="http://localhost/programa_de_trainee/modulo_3/javascript/avaliacao/Usuario/deletarUsuario/<?php echo $aUsuario['id']?>">
