...
class DependenteController {
    ...
    public function cadastrarDependente(array $aDados): void {
        ...
        if (!$bValidacao) {
            header("Location: http://localhost/programa_de_trainee/avaliacao/Dependente/save/{$iIdFiliado}");
            return;
        }
        ...
        header("Location: http://localhost/programa_de_trainee/avaliacao/Filiado/editar/{$iIdFiliado}");
    ...
    public function atualizarDependente(array $aDados): void {
        ...
        if (!$bValidacao) {
            header("Location: http://localhost/programa_de_trainee/avaliacao/Dependente/edit/{$iIdDependente}");
            return;
        }
