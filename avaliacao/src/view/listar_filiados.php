...
<body>
    <div class="container">
        <form action="http://localhost/programa_de_trainee/avaliacao/Filiado/listar" method="post">
        ...
        <a href="http://localhost/programa_de_trainee/avaliacao/Filiado/save">
                ...
                <?php foreach ($aFiliados as $aFiliado) { ?>
                    <tr>
                        ...
                        <th>
                           ...
                           <a href="http://localhost/programa_de_trainee/avaliacao/Filiado/editar/<?php echo $aFiliado['id']?>">
                            <button type="button" class="botao-verde" >Editar</button>
                           </a> 
                        </th>
                        <th>
                           <a href="http://localhost/programa_de_trainee/avaliacao/Filiado/deleteFiliado/<?php echo $aFiliado['id']?>">
