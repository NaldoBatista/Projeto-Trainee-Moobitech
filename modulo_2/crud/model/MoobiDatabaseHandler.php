...
class MoobiDatabaseHandler {
    ...
    public function __construct($aConfig) {
        $host = $aConfig['host']; //$rConfig->getHost();
        $porta = $aConfig['porta']; //$rConfig->getPorta();
        $dbname = $aConfig['dbname']; //$rConfig->getDbname();
        $usuario = $aConfig['usuario']; //$rConfig->getUsuario();
        $senha = $aConfig['senha']; //$rConfig->getSenha();
